        ...
        if (user) {
         var userId = firebase.auth().currentUser.uid;
            ...
            firebase.database().ref("donors/" + userId).once("value").then((data) => {
                ...
                document.getElementById("userName").innerHTML = alert.fname;
                ...
                swal({
                    ...
                    text: error.message,
                    confirmButtonColor: "rgb(18, 165, 165)"
                })
            })
            firebase.database().ref("acceptors/").once("value").then((data) => {
                ...
                for (var key in acceptors) {
                    ...
                    document.getElementById("acceptors").innerHTML += `
                        <div class='donorBox' id='${key}'>
                            ...
                            <hr />
                            <p class='oD' title='Age'><span style='font-weight:bold'><i class='fa fa-child' style='color:rgb(73, 209, 134);'></i> Age : </span> ${acceptors[key].age}</p>
                            <p class='oD' title='Gender'><span style='font-weight:bold'><i class='fa fa-neuter' style='color:rgb(73, 209, 134);'></i> Gender : </span> ${acceptors[key].gender}</p>
                            <p class='oD' title='Number'><span style='font-weight:bold'><i class='fa fa-phone' style='color:rgb(73, 209, 134);'></i> Phone : </span> ${acceptors[key].number}</p>
                            <p class='oD' title='Email'><span style='font-weight:bold'><i class='fa fa-envelope' style='color:rgb(73, 209, 134);'></i> Email : </span> ${acceptors[key].email}</p>
                            <p class='oD' title='Address'><span style='font-weight:bold'><i class='fa fa-map-marker' style='color:rgb(73, 209, 134);'></i> Address : </span> ${acceptors[key].address}</p>
                            <hr />
                            </div>
                            </div>  
                    `
                ...
                <thead style='background-color:rgb(73, 209, 134); color:white; font-weight:normal'>
                  <tr>
              ...
              <td style='color:rgb(73, 209, 134);' title='${counter}'>${counter}</td>
            </tr>
                </tbody>
              </table>
                `
            ...
            firebase.database().ref("donors/" + userId).once("value").then((data) => {
                ...
                swal({
                    ...
                    title: 'Something went wrong!',
                    text: error.message,
                    confirmButtonColor: "gb(18, 165, 165)"
                })
            })
        }
        else {
...
function filter(request) {
    ...
    if (request !== "default") {
        ...
        for (var key in donors) {
            ...
            <p id='${key + counter}'><button style='width:100%;' onclick='donate()' class='btn btn-danger'><i class='fa fa-plus-square'></i> Donate Now</button></p>
            <hr />
                <p class='oD' title='Age'><span style='font-weight:bold'><i class='fa fa-child' style='color:rgb(73, 209, 134);'></i> Age : </span> ${donors[key].age}</p>
                <p class='oD' title='Gender'><span style='font-weight:bold'><i class='fa fa-neuter' style='color:rgb(73, 209, 134);'></i> Gender : </span> ${donors[key].gender}</p>
                <p class='oD' title='Number'><span style='font-weight:bold'><i class='fa fa-phone' style='color:rgb(73, 209, 134);'></i> Phone : </span> ${donors[key].number}</p>
                <p class='oD' title='Email'><span style='font-weight:bold'><i class='fa fa-envelope' style='color:rgb(73, 209, 134);'></i> Email : </span> ${donors[key].email}</p>
                <p class='oD' title='Address'><span style='font-weight:bold'><i class='fa fa-map-marker' style='color:rgb(73, 209, 134);'></i> Address : </span> ${donors[key].address}</p>
                <hr />
            </div>  
             `
            }
